...
public class PitchConverter {
    ...
    private static double[] pitchLevel = new double[] {
        0.11, 0.14, 0.17, 0.19, 0.22, 0.25, 0.28, 0.30, 0.33, 0.36, 0.38, 0.41, 0.44, 0.47, 0.49,
        0.52, 0.55, 0.57, 0.60, 0.63, 0.66, 0.68, 0.71, 0.74, 0.76, 0.79, 0.82, 0.85, 0.87, 0.90
    };

    private static String[] pitchString = new String[] {
